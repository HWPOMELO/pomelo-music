...
const works = ref([{
    id: 1, link: "audio/Blossom.ogg", title: "Blossom", artist: "POMELO",
    img: "https://y.qq.com/music/photo_new/T002R300x300M000000J00QL445G5c_1.jpg?max_age=2592000"
}, {
    id: 2, link: "audio/Shelter(POMELO Remix).ogg", title: "Shelter(POMELO Remix)", artist: "POMELO",
    img: "https://y.qq.com/music/photo_new/T002R300x300M0000035s2tO4QwAKB_1.jpg?max_age=2592000"
}, {
    id: 3, link: "audio/動く、動く (POMELO Remix).ogg", title: "動く、動く (POMELO Remix)", artist: "POMELO",
    img: "https://y.qq.com/music/photo_new/T002R300x300M000000glNnP3FT1Ap_1.jpg?max_age=2592000"
}, {
    id: 4, link: "audio/Phoenix.ogg", title: "Phoenix", artist: "POMELO",
    img: "https://y.qq.com/music/photo_new/T002R300x300M000004gJVPk1e1Pls_1.jpg?max_age=2592000"
}, {
    id: 5, link: "audio/I Got This Love.ogg", title: "I Got This Love", artist: "POMELO/XHHANHAN",
...
createApp(App)
    .component("GTitle", GTitle)
    .component("GCard", GCard)
    .provide("works", works)
    .provide("playlist", playlist)
    .provide("links", links)
    .provide("friendship", friendship)
    .provide("currentSongId", currentSongId)
    .mount("#app");
